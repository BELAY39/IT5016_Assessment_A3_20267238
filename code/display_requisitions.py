...
def requisition_approval():
    ...
    return date,staff_id,staff_name,requisition_id,total,status,approval_reference

#Task 4:Display Requisition Information
def display_requisitions():
    date,staff_id,staff_name,requisition_id,total,status,approval_reference=requisition_approval()
